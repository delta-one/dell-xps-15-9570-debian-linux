...
### Kernel
**Note:** Kernel 5.0 causes a black flickering screen on the internal display of the 9570 at the moment. External monitors work fine. A (temporary) solution is mentioned [here](https://bugzilla.kernel.org/show_bug.cgi?id=202915) and resolves the problem.
